...
var FaxproC = UCPMC.extend({
	...
	displayWidget: function(widget_id, dashboard_id) {
		...
		$(".grid-stack-item[data-rawname=faxpro][data-id='"+widget_id+"'] .folder").click(function() {
			...
			$(".grid-stack-item[data-id='"+widget_id+"'] .fax-grid").bootstrapTable('refreshOptions',{
				url: UCP.ajaxUrl+'?module=faxpro&command=grid&folder='+folder+'&ext='+extension
			});
			if(folder == 'out' || folder == 'failed' || folder == 'sent') {
				$(".grid-stack-item[data-id='"+widget_id+"'] .fax-grid").bootstrapTable('showColumn','dest');
				$(".grid-stack-item[data-id='"+widget_id+"'] .fax-grid").bootstrapTable('hideColumn','callid');
			} else {
				$(".grid-stack-item[data-id='"+widget_id+"'] .fax-grid").bootstrapTable('hideColumn','dest');
				$(".grid-stack-item[data-id='"+widget_id+"'] .fax-grid").bootstrapTable('showColumn','callid');
			}
			$(".grid-stack-item[data-id='"+widget_id+"'] .fax-grid").bootstrapTable('showColumn','checkbox');
		});
		...
		$(document).on("click",".grid-stack-item[data-rawname=faxpro][data-id='"+widget_id+"'] .delete-selection", function() {
			UCP.showConfirm(_("Are you sure you wish to delete these faxes?"),'info',function() {
				var sel = $(".grid-stack-item[data-rawname=faxpro][data-id='"+widget_id+"'] .fax-grid").bootstrapTable('getSelections');
