...
class HttpTimeProvider implements ITimeProvider
{
     ...
     */
    public function __construct(public $url = 'https://google.com', public $expectedtimeformat = 'D, d M Y H:i:s O+', array $options = null)
    {
        if ($options === null) {
            $options = ['http' => ['method' => 'HEAD', 'follow_location' => false, 'ignore_errors' => true, 'max_redirects' => 0, 'request_fulluri' => true, 'header' => ['Connection: close', 'User-agent: TwoFactorAuth HttpTimeProvider (https://github.com/RobThree/TwoFactorAuth)', 'Cache-Control: no-cache']]];
        }
