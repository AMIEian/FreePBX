...
class TwoFactorAuthTest extends TestCase
{
    ...
    public function testGetCodeReturnsCorrectResults()
    {
        ...
        $this->assertEquals('543160', $tfa->getCode('VMR466AB62ZBOKHE', 1_426_847_216));
    ...
    public function testVerifyCodeWorksCorrectly()
    {
        ...
        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '543160', 1, 1_426_847_190));
        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '543160', 0, 1_426_847_190 + 29));	//Test discrepancy
        $this->assertFalse($tfa->verifyCode('VMR466AB62ZBOKHE', '543160', 0, 1_426_847_190 + 30));	//Test discrepancy
        $this->assertFalse($tfa->verifyCode('VMR466AB62ZBOKHE', '543160', 0, 1_426_847_190 - 1));	//Test discrepancy

        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '543160', 1, 1_426_847_205 + 0));	//Test discrepancy
        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '543160', 1, 1_426_847_205 + 35));	//Test discrepancy
        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '543160', 1, 1_426_847_205 - 35));	//Test discrepancy

        $this->assertFalse($tfa->verifyCode('VMR466AB62ZBOKHE', '543160', 1, 1_426_847_205 + 65));	//Test discrepancy
        $this->assertFalse($tfa->verifyCode('VMR466AB62ZBOKHE', '543160', 1, 1_426_847_205 - 65));	//Test discrepancy

        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '543160', 2, 1_426_847_205 + 65));	//Test discrepancy
        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '543160', 2, 1_426_847_205 - 65));	//Test discrepancy
    }
    ...
    public function testVerifyCorrectTimeSliceIsReturned()
    {
        ...
        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '534113', 3, 1_426_847_190, $timeslice1));
        $this->assertEquals(47_561_570, $timeslice1);
        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '819652', 3, 1_426_847_190, $timeslice2));
        $this->assertEquals(47_561_571, $timeslice2);
        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '915954', 3, 1_426_847_190, $timeslice3));
        $this->assertEquals(47_561_572, $timeslice3);
        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '543160', 3, 1_426_847_190, $timeslice4));
        $this->assertEquals(47_561_573, $timeslice4);
        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '348401', 3, 1_426_847_190, $timeslice5));
        $this->assertEquals(47_561_574, $timeslice5);
        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '648525', 3, 1_426_847_190, $timeslice6));
        $this->assertEquals(47_561_575, $timeslice6);
        $this->assertTrue($tfa->verifyCode('VMR466AB62ZBOKHE', '170645', 3, 1_426_847_190, $timeslice7));
        $this->assertEquals(47_561_576, $timeslice7);

        // Incorrect code should return false and a 0 timeslice
        $this->assertFalse($tfa->verifyCode('VMR466AB62ZBOKHE', '111111', 3, 1_426_847_190, $timeslice8));
    ...
    public function testKnownTestVectors_sha1()
    {
        ...
        $this->assertEquals('07081804', $tfa->getCode($secret, 1_111_111_109));
        $this->assertEquals('14050471', $tfa->getCode($secret, 1_111_111_111));
        $this->assertEquals('89005924', $tfa->getCode($secret, 1_234_567_890));
        $this->assertEquals('69279037', $tfa->getCode($secret, 2_000_000_000));
        $this->assertEquals('65353130', $tfa->getCode($secret, 20_000_000_000));
    }
    ...
    public function testKnownTestVectors_sha256()
    {
        ...
        $this->assertEquals('68084774', $tfa->getCode($secret, 1_111_111_109));
        $this->assertEquals('67062674', $tfa->getCode($secret, 1_111_111_111));
        $this->assertEquals('91819424', $tfa->getCode($secret, 1_234_567_890));
        $this->assertEquals('90698825', $tfa->getCode($secret, 2_000_000_000));
        $this->assertEquals('77737706', $tfa->getCode($secret, 20_000_000_000));
    }
    ...
    public function testKnownTestVectors_sha512()
    {
        ...
        $this->assertEquals('25091201', $tfa->getCode($secret, 1_111_111_109));
        $this->assertEquals('99943326', $tfa->getCode($secret, 1_111_111_111));
        $this->assertEquals('93441116', $tfa->getCode($secret, 1_234_567_890));
        $this->assertEquals('38618901', $tfa->getCode($secret, 2_000_000_000));
        $this->assertEquals('47863826', $tfa->getCode($secret, 20_000_000_000));
    }
}
