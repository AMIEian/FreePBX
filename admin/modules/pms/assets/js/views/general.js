...
$(document).ready(function() {
    ...
    function change_om(om) {
        console.log("Selected operating mode:", om);
        $.ajax({
            url: "ajax.php?module=pms&change_om=" + encodeURIComponent(om),
            dataType: "json",
            success: function(json) {
                // Display a success message
                fpbxToast(_("Operating mode changed successfully"), 'Success', 'success');
            ...
            error: function(xhr, status, error) {
                ...
                fpbxToast(_("An Ajax error occurred! Please check console logs."), 'Error', 'error');
