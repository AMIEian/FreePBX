var ScribeC = UCPMC.extend({
	...
	init: function(){
		...
		console.log('%c'+sprintf(_("scribe has been loaded at %s"),UCP.dateTimeFormatter(this.time)),'background: #222; color: #bada55');
		console.log('%c'+sprintf(_("scribe has been loaded at %s"),UCP.timeFormatter(this.time)),'background: #222; color: #bada55');
		console.log('%c'+sprintf(_("scribe has been loaded at %s"),UCP.dateFormatter(this.time)),'background: #222; color: #bada55');
	...
	prepoll: function() {
		var items = {};
		$(".grid-stack-item[data-rawname=scribe][data-widget_type_id=poll]").each(function() {
			var id = $(this).data("id");
	...
	poll: function(data){
		...
		//$("#scribe-badge").text(data.total);
		//$("#nav-btn-scribe .badge").text(data.total);
