...
<div class="freepbx-navbar">
	<nav class="navbar navbar-expand-lg fixed-top" role="navigation">
		...
		<a class="navbar-brand" href="#">
			<img src="modules/dashboard/views/logo.png" alt="Teletech" title="Teletech" id="MENU_BRAND_IMAGE_TANGO_LEFT" data-BRAND_IMAGE_FREEPBX_LINK_LEFT="<?php echo $amp_conf['BRAND_IMAGE_FREEPBX_LINK_LEFT']; ?>" />
		</a>
